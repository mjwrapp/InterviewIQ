...
Return strictly JSON:
{
  ...
  "skills": ["skill1","skill2"]
    ...
    const aiResponse = await askAi(messages); // FIXED variable

    const parsed = JSON.parse(aiResponse); // FIXED name
    ...
    if (req.file && fs.existsSync(req.file.path)) { // FIXED req
...
export const finishInterview = async(req,res)=>{
 ...
 //6:35 :11 on video will resue kal
  } catch (error) {
