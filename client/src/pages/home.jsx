...
<span className='relative inline-block'>
 ...
 Role-based mock interviews with smart follw-ups,adaptive difficulty and real time performance evaluation.
  </motion.p>
  ...
  >
   ...
   {item.icon}
    ...
    <div className='pt-10 text-center'>
      <div className='test-xs text-green-600 font-semibold mb-2 tracking wider'>{item.step}</div>
   ...
   <div className='grid grid-cols-2 gap-10'>
    {
      [
        ...
        },
        {
          ...
          desc:"Track progress with detailed performance metrics and topic analysis."
        }
      ].map((item, index) => (
        ...
        <div className='flex flex-col md:flex-row items-center gap-8'>
          <div className='w-full md:w-1/2 flex justify-center'> <img src={item.image} alt={item.title}
          className='w-full h-auto object-contain max-h-64'/></div>
